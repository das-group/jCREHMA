...
import de.thk.das.rest.security.http.crehma.ResponseSigner;
...
public class SigningResponseInterceptor extends ResponseSigner implements
	...
	public SigningResponseInterceptor(){
		super();
	}
	
	public SigningResponseInterceptor(String kid,TbsAuthenticator tbsAuthenticator, BodyHasher bodyHasher) {
	...
	public void process(HttpResponse response, HttpContext context)
		...
		try {
			sign(response, this.sig, this.kid, this.hash, this.additionalHeaders, context.getAttribute("Method").toString(), context.getAttribute("Uri").toString());
		} catch (Exception e) {
			e.printStackTrace();
		}
